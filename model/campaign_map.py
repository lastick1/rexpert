...
class CampaignMap:
    ...
    def __init__(
        ...
        self.date = datetime.datetime.strptime(
            date, constants.DATE_FORMAT)  # дата последней завершённой миссии
        self.mission_date = datetime.datetime.strptime(
            mission_date, constants.DATE_FORMAT)  # дата текущей миссии

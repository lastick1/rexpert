...
* Атаковать возможно только фронтовые аэродромы, присутствующие в миссии.
* У всех аэродромов накапливается урон от миссии к миссии. Пополняются только активные в миссии аэродромы.
* Если аэродром выбили на 50%(?), то начинается миссия по его захвату (одна из сторон переходит в наступление). Задача атакующих - сохранить преимущество, обороняющихся - сорвать наступление.
